		...
		<div class="container">
			...
			<div class="navbar-collapse d-flex justify-content-end" id="navbarText">
				<ul class="navbar-nav container-nav-bar">
					...
					<li class="nav-item">
						<a class="nav-link" href="assets/agenda.asp">Agenda</a>
					</li>
					<li class="nav-item">
			...
			<div class="pt-4 card-box-bottom">
				...
				<div class="row pt-lg-5">
					<div class="col">
						...
						<p class="text-muted mb-1 pt-2 card-itens-bottom">Paraciclos instalados</p>
					</div>
					...
					<div class="col">
						...
						<p class="text-muted mb-1 pt-2 card-itens-bottom">Instraestrutura cicloviária</p>
					</div>
				</div>			
			</div>
		</div>
        ...
        <div class="container bottom_border">
            <div class="row">
                <div class=" col-sm-6 col-md-6 col-sm-6  col-12 col">
                    <h5 class="headin5_amrc col_white_amrc pt2">Projeto do sitema cicloviário no Parque Mambucaba</h5>
                    <!--headin5_amrc-->
                    
                    <p><span class="material-symbols-outlined">pin_drop</span> <a href="https://goo.gl/maps/gTc2i5yvJZQ4c2KX6" target="_blank"> Rua do Comércio, 17 - Centro.</a>  </p>
                    <p><span class="material-symbols-outlined">call</span> <a href="tel:+552433686441" target="_blank"> (24) 3368-6441</a>  </p>
                    <p><span class="material-symbols-outlined">mail</span> <a href="mailto:planodiretor@angra.rj.gov.br" target="_blank"> planodiretor@angra.rj.gov.br</a> </p>


                </div>

                <!-- <div class=" col-sm-3 col-md-3  col-6 col">
                    <h5 class="headin5_amrc col_white_amrc pt2">Prefeitura de Angra</h5>
                    <ul class="footer_ul_amrc">
                      <li><a href="https://angra.rj.gov.br/sala-de-imprensa.asp?IndexSigla=imp" target="_blank">Notícias</a></li>
                      <li><a href="https://angra.rj.gov.br/secretaria.asp?indexsigla=transp" target="_blank">Portal da Transparência</a></li>
                      <li><a href="https://angra.rj.gov.br/boletim-oficial.asp?indexsigla=imp" target="_blank">Boletim Oficial</a></li>
                ...
                <div class=" col-sm-3 col-md-3 col-12 col text-center">
                    ...
                    <img src="images/mambubike-logo.svg" style="height: 150px; width: auto" alt="">
                </div>
            </div>
        </div>
            ...
            <p class="text-center">Secretaria de Segurança Pública de Angra dos Reis</p>
