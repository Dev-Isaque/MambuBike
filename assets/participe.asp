...
If Request.ServerVariables("REQUEST_METHOD") = "POST" Then
	...
	If vnm_participante <> "" AND vds_email <> "" Then
		vSql = "INSERT INTO TB_PMAR_SEOPM_QUESTIONARIO_MAMBUBIKE_2023 (nm_participante,ds_faixa_etaria,ds_genero,ds_escolaridade,ds_cor,id_bairro,sn_diversidade_funcional,ds_diversidade_funcional,nr_telefone " &_
				...
				",ds_bicicleta_desafios_uso,ds_bicicleta_tempo_medio,sn_ocorrencia_acidente,ds_descricao_ocorrencia,ds_local_ocorrencia,sn_transp_associado,ds_transp_associado,ds_transp_associado_outros,ds_vias_prioritarias,ds_sugestoes_mobilidade) " &_
...
<div class="container">
	<form action="participe.asp" method="POST" class="g-3 needs-validation" novalidate>
		...
		<p style="text-align: center; padding: 50px 350px;">Esse questionário é uma etapa da participação popular para o desenvolvimento do projeto MambuBike – Sistema Cicloviário do Parque Mambucaba. Sua participação é muito importante.</p>
		...
		<div class="mb-3">
			...
			<input type="text" class="form-control telefone" id="txtTelefone" name="txtTelefone" maxlength="15" placeholder="(**) *****-****" pattern="\([0-9]{2}\)[\s][0-9]{4,5}-[0-9]{4}">
		</div>
		<br>
		<br>
		<br>
		...
		<div>
			...
			<div class="form-check form-check-inline">
				...
				<input type="text" class="form-control" id="txtTranspMaisUtiliza" name="txtTranspMaisUtiliza">
			</div>
		</div>
		<br>
		...
		<div id="ciclistas">
			...
			<div>
				...
				<div class="form-check">
					...
					<input type="text" class="form-control" id="txtBicicletaMotivoViagemOutro" name="txtBicicletaMotivoViagemOutro">
				</div>
			</div>
			<br>
			...
			<div>
				...
				<div class="form-check form-check-inline">
					<input class="form-check-input" type="radio" name="radioQtdPessoas" id="radioQtdPessoas2" value="21 passageiro(a)">
					<label class="form-check-label" for="radioQtdPessoas2">21 passageiro(a)</label>
				</div>
				<div class="form-check form-check-inline">
			...
			<div>
				...
				<div class="form-check form-check-inline">
					...
					<input type="text" class="form-control" id="txtBicicletaMotivoUsoOutros" name="txtBicicletaMotivoUsoOutros">
				</div>
			</div>
			<br>
			...
			<div>
				...
				<div class="form-check">
					...
					<input type="text" class="form-control" id="txtBicicletaDesafiosUsoOutro" name="txtBicicletaDesafiosUsoOutro">
				</div>
			</div>
			<br>
			...
			<div>
				...
				<div class="form-check form-check-inline">
					<input class="form-check-input" type="radio" name="radioUsoAssociadaOutroTransp" id="radioUsoAssociadaOutroTransp1" value="option1">
					<label class="form-check-label" for="radioUsoAssociadaOutroTransp1">Sim</label>
				</div>
				<div class="form-check form-check-inline">
					<input class="form-check-input" type="radio" name="radioUsoAssociadaOutroTransp" id="radioUsoAssociadaOutroTransp2" value="option2">
				...
				<div class="form-check">
					...
					<input type="text" class="form-control" id="txtUsoOutrosTransp" name="txtUsoOutrosTransp">
				</div>
			</div>
			<br>
			...
			<div>
				<div class="mb-3">
					<label for="txtViasPrioritarias" class="form-label"><h6><strong>I.</strong> Dentro do seu bairros, quais as vias que você considera como prioritárias para integrar	um sistema cicloviário?</h6></label>
			...
			<div>
				<div class="mb-3">
					<label for="txtSugestoesMobilidade" class="form-label"><h6><strong>J.</strong> Escreva aqui as suas sugestões em relação à mobilidade por bicicletas no seu bairro.<strong style="color: rgb(30, 148, 30);">Opcional</strong></h6></label>
