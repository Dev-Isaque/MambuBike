...
<body>
	...
	<header class="header-home" id="header">
		<img src="images/mambubike-logo.svg" id="imagemLogo">
	</header>
	...
	<footer class="footer">
        <div class="container bottom_border">
            <div class="row">
                ...
                <div class=" col-sm-3 col-md-3 col-12 col text-center bg-logo">
                    <img src="images/Logo-prefeitura-footer.png" style="height: 100px; width: auto" alt="">
                </div>
            </div>
        </div>
            ...
            <p class="text-center">Secretaria executiva de ordem pública e mobilidade Urbana</p>
