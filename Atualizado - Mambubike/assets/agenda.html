...
<body>
	...
	<section style="background-color: #F0F2F5; padding-top: 40px;">
            ...
            <div class="main-timeline-2">
                ...
                <div class="timeline-2 left-2 animacao hidden card-box-left">
                    ...
                    <div class="card-body p-4">
                        <h4 class="fw-bold mb-4 card-itens-left">Ut enim ad minim veniam</h4>
                        <p class="text-muted mb-4 card-itens-left"><i class="far fa-clock" aria-hidden="true"></i> 2017</p>
                        <p class="mb-0 card-itens-left">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                ...
                <div class="timeline-2 right-2 card-box-right">
                    ...
                    <img src="https://mdbcdn.b-cdn.net/img/Photos/Slides/img%20(129).webp" class="card-img-top"
                        alt="Responsive image">
                    <div class="card-body p-4">
                        <h4 class="fw-bold mb-4 card-itens-right">Duis aute irure dolor</h4>
                        <p class="text-muted mb-4 card-itens-right"><i class="far fa-clock" aria-hidden="true"></i> 2016</p>
                        <p class="mb-0 card-itens-right">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium
                ...
                <div class="timeline-2 left-2 card-box-left">
                    <div class="card">
                    <img src="https://mdbcdn.b-cdn.net/img/Photos/Slides/img%20(131).webp" class="card-img-top"
                        alt="Responsive image">
                    <div class="card-body p-4">
                        <h4 class="fw-bold mb-4 card-itens-left">Sed ut nihil unde omnis</h4>
                        <p class="text-muted mb-4 card-itens-left"><i class="far fa-clock" aria-hidden="true"></i> 2015</p>
                        <p class="mb-0 card-itens-left">Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur,
                ...
                <div class="timeline-2 right-2 card-box-right">
                    ...
                    <img src="https://mdbcdn.b-cdn.net/img/Photos/Slides/img%20(125).webp" class="card-img-top"
                        alt="Responsive image">
                    <div class="card-body p-4">
                        <h4 class="fw-bold mb-4 card-itens-right"> Quis autem vel eum voluptate</h4>
                        <p class="text-muted mb-4 card-itens-right"><i class="far fa-clock" aria-hidden="true"></i> 2014</p>
                        <p class="mb-0 card-itens-right">At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis
                ...
                <div class="timeline-2 left-2 card-box-left">
                    <div class="card">
                    <img src="https://mdbcdn.b-cdn.net/img/Photos/Slides/img%20(144).webp" class="card-img-top animacao-delay"
                        alt="Responsive image">
                    <div class="card-body p-4">
                        <h4 class="fw-bold mb-4 card-itens-left">Mussum ipsum cacilds</h4>
                        <p class="text-muted mb-4 card-itens-left"><i class="far fa-clock"></i> 2013</p>
                        <p class="mb-0 card-itens-left">Temporibus autem quibusdam et aut officiis debitis aut rerum necessitatibus
